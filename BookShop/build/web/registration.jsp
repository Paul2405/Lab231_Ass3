        ...
        <div class="container text-center padding-vertical-100">
            ...
            <div class="row justify-content-md-center"  >
                <div class="col-md-6 col-sm-6" >
                    <form action="RegistrationController" method="POST" class="contact-form padding-top-50 margin-bottom-15">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <div class="form-group text-right">
                                    <input type="text" name="txtUsername" id="email" class="form-control" value="${param.txtUsername}" required>
                                </div>
                                <!-- /form-group -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <font color="red">${requestScope.INVALID.confirmPasswordError}<font>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group text-left">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <div class="form-group text-right">
                                    <input type="text" name="txtFullname" id="fullname" class="form-control" value="${param.txtFullname}" required>
                                </div>
                                <!-- /form-group -->
                            </div>
                        </div>
                        <div class="row">
                            <input type="submit" name="action" value="Registry"  class="btn btn-login"/>
                        </div>
                    </form>
