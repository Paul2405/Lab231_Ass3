...
<html>
    ...
    <body>
        ...
        <div class="container text-center padding-vertical-50">
            <h2 class="double-line"><span>add new categories</span></h2>
            <div class="row justify-content-md-center"  >
                <div class="col-md-6 col-sm-6" >
                    <form action="AddCategoryAdminController" method="POST" class="contact-form padding-top-50 margin-bottom-15">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group text-right">
                                    <textarea  name="txtDescription" id="short-description" class="form-control" style="height: 100px;" required>${param.txtDescription}</textarea>
                                </div>
                                <!-- /form-group -->
                            </div>
                        </div>
                        <div class="row">
                            <input type="submit" name="action" value="Add Category" class="btn btn-login"/>
                        </div>
